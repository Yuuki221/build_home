var canvas = require('setup-canvas.js');
window.onload = function(){
	...
	// append other elements on canvas
	function drawMoon(){
		var img = new Image();
		img.onload = function(){
		...
		img.src = './icons/svg/full-moon.svg';
	} 

	function drawStar(x, y){
		var img = new Image();
		img.onload = function(){
			ctx.drawImage(img, 100, 100, x, y);
	...
	function drawFire(){
		var img = new Image();
		img.onload = function(){
			ctx.drawImage(img, 600, 400, 100, 100);
			console.log('draw fire');
		};
